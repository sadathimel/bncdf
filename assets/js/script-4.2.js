...
$(document).ready(function () {
    $(".form-newsletter").submit(function (event) {
        ...
        if($("#" + formId + " #fname").val() !== undefined){
            var fname = $("#" + formId + " #fname").val().trim();
        }
        if($("#" + formId + " #lname").val() !== undefined){
            var lname = $("#" + formId + " #lname").val().trim();
        }
        if($("#" + formId + " #country").val() !== undefined){
            var country = $("#" + formId + " #country").val().trim();
        }
        if($("#" + formId + " #org").val() !== undefined){
            var org = $("#" + formId + " #org").val().trim();
        }
        if (email == "") {
            $(input).addClass('has-error');
            if (formId == "form_newsletter_footer") {
                $(".well-newsletter").addClass("expanded");
            }
            return false;
        } else {
